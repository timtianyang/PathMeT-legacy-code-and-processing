...
void initLaz(){//UART3 to Laz
   ...
   UART3_Init_Advanced(115200,_UART_8BIT_NOPARITY,_UART_ONE_STOPBIT,_UART_HI_SPEED);          //connect to sensor @230400
   Delay_ms(100);
...
void LazInterrupt() iv IVT_ADDR_U3RXINTERRUPT ics ICS_AUTO {
   ...
   if(LazIterator==3){LazIterator=0;}//chongfu jiancha
