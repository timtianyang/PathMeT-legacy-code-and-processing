#line 1 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
#line 1 "d:/desktopbak/github/pathmet/dc_code/dc_tim708backuplazer/newdesignft800/newdesignft800/newdesign_code/mikroc pro for dspic/camfunctionheader.h"
...
void logGPSToSD();
#line 2 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
void LEDIndicator(){
 LATA.B1=0;
 Delay_ms(1000);
 LATA.B1=1;
...
#line 393 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
void initGPS(){
...
void logGPSToSD(){
 ...
 FAT32_Write(GPSfile,ProcessedGPSString, strlen(ProcessedGPSString));
 FAT32_Write(GPSfile, "\r\n",2);

 FAT32_Close(GPSfile);
#line 534 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
 return;
...
void main() {
 ...
 if(enableGPSOutput){
 enableGPSOutput=0;
#line 639 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
 }
 if(disableGPSOutput){
 disableGPSOutput=0;
#line 649 "D:/desktopbak/github/PathMeT/DC_Code/DC_tim708backuplazer/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/GPSCamChip.c"
 PicnumIncrementor=0;
 oldPicNum=0;
 }
