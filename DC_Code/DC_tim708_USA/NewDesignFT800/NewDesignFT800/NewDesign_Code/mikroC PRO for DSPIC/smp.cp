#line 1 "C:/Users/tic27/Desktop/DC_tim708_USA/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/smp.c"
#line 1 "c:/users/tic27/desktop/dc_tim708_usa/newdesignft800/newdesignft800/newdesign_code/mikroc pro for dspic/smpfunctionheader.h"
...
void stopWorm();
#line 3 "C:/Users/tic27/Desktop/DC_tim708_USA/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/smp.c"
unsigned char i=0;
void initChip(){
 PLLFBD = 68;
 CLKDIV = 0x0000;
...
void ScreenChipInterrupt() iv IVT_ADDR_U2RXINTERRUPT {
 ...
 UART1_Write(temp);
 break;
#line 191 "C:/Users/tic27/Desktop/DC_tim708_USA/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/smp.c"
 }
 }
...
void initLaz(){
 ...
 UART3_Init_Advanced(9600,_UART_8BIT_EVENPARITY,_UART_ONE_STOPBIT,_UART_HI_SPEED);
 Delay_ms(1000);
 for (iterator=0;iterator<7;iterator++){UART3_Write(setBaud[iterator]);}
 Delay_ms(100);

 UART3_Init_Advanced(460800,_UART_8BIT_EVENPARITY,_UART_ONE_STOPBIT,_UART_HI_SPEED);
 Delay_ms(100);
...
void init9DOF(){
 ...
 IEC5.B8=1;
 U4STA.OERR=0;
#line 256 "C:/Users/tic27/Desktop/DC_tim708_USA/NewDesignFT800/NewDesignFT800/NewDesign_Code/mikroC PRO for DSPIC/smp.c"
 Delay_ms(500);
 DofIterator=0;
